    ...
    public partial class Categories1 : Migration
    {
        ...
        protected override void Down(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.UpdateData(
                ...
                keyValue: 2,
                columns: new[] { "Description", "ImageUrl", "Price", "Title" },
                values: new object[] { "Java是一门面向对象的编程语言，不仅吸收了C++语言的各种优点，还摒弃了C++里难以理解的多继承、指针等概念，因此Java语言具有功能强大和简单易用两个特征。Java语言作为静态面向对象编程语言的代表，极好地实现了面向对象理论，允许程序员以优雅的思维方式进行复杂的编程", "https://ts1.cn.mm.bing.net/th/id/R-C.cc5dfaddc5c49eec3900490e1e97e2f4?rik=ExP1i6ccA46OQg&riu=http%3a%2f%2fpic.qqtn.com%2fup%2f2017-8%2f2017083009461224505.jpg&ehk=XgUQDp6KbJAJBGleeWml5cmqdYE7iL0vT8Bu%2fGfB3N8%3d&risl=&pid=ImgRaw&r=0&sres=1&sresct=1", 7.99m, "JAVA" });
